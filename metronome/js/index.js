...
/*
Scheduling Help by: http://www.html5rocks.com/en/tutorials/audio/scheduling/
*/
function schedule() {
...
if($(this).data("what") === "pause")
{
  ...
  $(".counter .dot").attr("style", "");
  $(this).data("what", "play").attr("style","").html("<i class=\"fa fa-play\" aria-hidden=true style=\"color:white\"></i>");
}
else {
  // ====== Play ====== //
...
if( $("#timer-check").is(":checked") )
 {
  ...
  $(this).data("what", "pause").css({
    background: "#F75454",
    color: "#FFF"
  }).html("<i class=\"fa fa-stop\" aria-hidden=true style=\"color:white\"></i>");
}
});